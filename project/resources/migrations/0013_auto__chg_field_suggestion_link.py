...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Suggestion.link'
        db.alter_column(u'resources_suggestion', 'link', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Suggestion.link'
        db.alter_column(u'resources_suggestion', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))
