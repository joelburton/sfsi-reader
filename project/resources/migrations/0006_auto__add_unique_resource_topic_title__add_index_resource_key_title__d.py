...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Resource', fields ['topic', 'title']
        db.create_unique(u'resources_resource', ['topic_id', 'title'])

        # Adding index on 'Resource', fields ['key', 'title']
        db.create_index(u'resources_resource', ['key', 'title'])

        # Adding unique constraint on 'Day', fields ['title']
        db.create_unique(u'resources_day', ['title'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Day', fields ['title']
        db.delete_unique(u'resources_day', ['title'])

        # Removing index on 'Resource', fields ['key', 'title']
        db.delete_index(u'resources_resource', ['key', 'title'])

        # Removing unique constraint on 'Resource', fields ['topic', 'title']
        db.delete_unique(u'resources_resource', ['topic_id', 'title'])
