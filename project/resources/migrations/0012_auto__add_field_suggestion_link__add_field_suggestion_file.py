...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Suggestion.link'
        db.add_column(u'resources_suggestion', 'link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Suggestion.file'
        db.add_column(u'resources_suggestion', 'file',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Suggestion.link'
        db.delete_column(u'resources_suggestion', 'link')

        # Deleting field 'Suggestion.file'
        db.delete_column(u'resources_suggestion', 'file')
