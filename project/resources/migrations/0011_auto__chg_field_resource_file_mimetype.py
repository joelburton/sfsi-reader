...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Resource.file_mimetype'
        db.alter_column(u'resources_resource', 'file_mimetype', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Resource.file_mimetype'
        db.alter_column(u'resources_resource', 'file_mimetype', self.gf('django.db.models.fields.CharField')(max_length=30))
